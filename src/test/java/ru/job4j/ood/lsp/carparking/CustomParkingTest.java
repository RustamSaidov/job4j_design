...
class CustomParkingTest {
    ...
    public void whenTruckParkingIsFilledAndTruckGoesToPassParkingWhichIsPartlyFilledAndTheAnotherOnePassCarFilledPassParking() {
        ...
        assertTrue(customParking.checkAndAddCar(car1));
        assertTrue(customParking.checkAndAddCar(car2));
        assertTrue(customParking.checkAndAddCar(car11));
        assertTrue(customParking.checkAndAddCar(car22));
        assertTrue(customParking.checkAndAddCar(car3));
        assertFalse(customParking.checkAndAddCar(car4));
        assertTrue(customParking.checkAndAddCar(car55));
        assertFalse(customParking.checkAndAddCar(car66));
        truckArray[0] = car1;
        truckArray[1] = car2;
